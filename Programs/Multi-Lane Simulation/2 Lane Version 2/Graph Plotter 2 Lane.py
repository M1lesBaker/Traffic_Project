...
def time_tick(time1,interval, frames):
...
time = T[:len(X)]
time1 =[]
subplot_suvat_graph(time[:8100],L[:8100],X[:8100],Y[:8100])
#subplot_suvat_graph(time_tick(time1,0.011111111,len(X))[:8100],L[:8100],X[:8100],Y[:8100])
