...
def accel(velocity, reaction, speed_diff, position_diff,max_speed,accel_max):
...
decel_max = 3 #pixels/second^2 Comfortable deceleration # reset at 17:29
...
for i in range(int(start/increment),int(stop/increment)): #cannot get decimals so will build this into code/
    car1 = Car(1,400,290, 0, 0, 5, 1000, 'blue', 30, reaction,0) #reset car each interation
    car2 = Car(1, 400, 200, 0, 0, 5, 1000, 'green', 30, reaction, 1)
    ...
    while run:
        ...
        car1.acceleration = accel(car1.speed, 0.67, 0, 100000000000000000000, car1.speed_des, 2) # calculates acceleration
...
plt.ylabel('$a$ - Max Acceleration', labelpad=20)
